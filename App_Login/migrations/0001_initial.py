    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='user can login can login this site', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='user should active.Unselect to make inactive', verbose_name='active')),
